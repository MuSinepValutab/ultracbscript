...
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/MuSinepValutab/ultracbscript/refs/heads/main/Sirius%20Library%20Modded'))()
...
local Window = Library:CreateWindow({
    ...
    KeySettings = {
        ...
        Key = {"sigmatonu"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
})
            ...
            Callback = function()
                for _, Weapon in ipairs(Weapons:GetChildren()) do
                    if Weapon:FindFirstChild("Ammo") and Weapon:FindFirstChild("StoredAmmo") then
                        Weapon:FindFirstChild("Ammo").Value = 999999
                        Weapon:FindFirstChild("StoredAmmo").Value = 99999999
                    end 
                end
            end,
        })
